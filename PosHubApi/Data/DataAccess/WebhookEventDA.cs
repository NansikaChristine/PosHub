...
namespace PosHubApi.Data.DataAccess
{
    public class WebhookEventDA
    {
        ...
        #region UpdateOrderWebhookEvent
        public async Task<bool> UpdateOrderWebhookEvent(OrderWebhookEventRequestDto xWebhookRequest, string apiCall)
        {
            string sql = @"
                            INSERT INTO OrderWebhookEvents (
                                EventId, AccountId, ClientId, OrderId, LocationId,
                            ...
                            VALUES (
                                CONCAT(@EventId, '_', FORMAT(SYSDATETIME(), 'yyyyMMddHHmmssfff')),
                                @AccountId, @ClientId, @OrderId, @LocationId,
                                @EventTime, @ConnectionId, @EventType, @ObjectType,
                                @NewState, @PreviousState, @Status, @SourceName, @Total
                            ) ";
        ...
        #endregion UpdateOrderWebhookEvent
